...
function $pricesLine(x){
  ...
  console.log($PriceLoad + ' - ' +$priceRetail);
};
...
function $summary(){
  ...
  $('.product-form .build-set-container .build-set__item').each(function(){
    ...
    var $html = '<div class="item-summary"><p class="heading">'+ $heading +'</p><p class="sku"><span>Your Price</span><span>Retail</span></p><p class="price">'+ $price +'</p></div>';
